...
/*
    ...
    Tipp: Modulu rechnen ist am einfachsten!
*/
...
/*
    ...
    Hilfestellung:
      split('') = splitet einen String in seine einzelnen Buchstaben (Ausgabe ist ein Array = ["H","a","l","l","o"] = "Hallo".split(''))
      reverse() = dreht ein Array um (Ausgabe ist ein Array = ["o", "l", "l", "a", "H"] = ["H","a","l","l","o"].reverse())
      join('')  = summiert alle Buchstaben aus einem Array zusammen zu einem String (Ausgabe ist ein String = "ollaH" = ["o", "l", "l", "a", "H"].join(''))
*/
...
/*
    ...
    Tipp: String.length gibt einen Int als länge des Strings zurück = ( 5 = "Hallo".length )
*/
